...
module.exports.run = async(bot, message, args, dbGuild) => {
    ...
    const e = generateDefaultEmbed({title: `Search: ${searchCriteria}`, description: desc})
    ...
    const collector = msg.createReactionCollector(
        ...
        (reaction, user) => ["1️⃣", "2️⃣", "3️⃣"].includes(reaction.emoji.name) && user.id === message.author.id,
    ...
    collector.on('collect', (reaction) => {
        ...
        msg.reactions.removeAll().then(async() => {
            ...
            // edit msg with new embed showing the selection
