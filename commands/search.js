...
cmd.setExecute(async (client, message, args, cmd) => {
    ...
    const e = await client.operations.get("generateDefaultEmbed")({
    ...
    msg.awaitReactions(filter, { max: 1, time: 30000, errors: ['time'] })
        ...
        .catch(() => {
            ...
            msg.reactions.removeAll().then(async () => {
                ...
                await client.operations.get("deleteCatch")(msg, 8000);
                await client.operations.get("deleteCatch")(message, 8000);
            })
        });
});
